...
{
    convenience init(teacherRec1: String, teacherRec2: String, teacherRec3: String, username: String, password: String, datepicker: UIDatePicker, datepickertextfield: String, reqTesting: String, numberOfEssays: String, letterOrForm: NSNumber, commonApp: NSNumber, image: UIImage?, location: String, inManagedObjectContext managedObjectContext: NSManagedObjectContext)
    {
